...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Titulo.setText("Calculadora de Retangulo");

        jLabel4.setText("Calcule Área e Perímetro de um Retângulo");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel_Titulo, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel2.setText("Digite Comprimento");

        jLabel3.setText("Digite Largura");
    ...
    private void jButton_CalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_CalcularActionPerformed
        ...
        objRetangulo.setComprimento(Float.parseFloat(jTextField_Comprimento.getText().replaceAll(",", ".")));
        objRetangulo.setLargura(Float.parseFloat(jTextField_Largura.getText().replaceAll(",", ".")));
        
       
        String saida = "Perimetro: "+ String.format("%.2f \n", objRetangulo.calcularPerimetro());
        saida+="Area: "+String.format("%.2f \n", objRetangulo.calcularArea());
        
         //Condição para o programa nao receber numeros negativos
        if((Float.parseFloat(jTextField_Comprimento.getText().replaceAll(",", "."))< 0) 
                || (Float.parseFloat(jTextField_Largura.getText().replaceAll(",", ".")) < 0)){
         // Saida
            jTextArea_Resultado.setText(" Digite Número Maior que Zero!");
        }
        else{
            // Saida
        jTextArea_Resultado.setText(saida);
        jTextField_Comprimento.setText(" ");
        jTextField_Largura.setText(" ");
        }
