...
public class TelaCilindro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Calculadora Cilindro");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jButton_Calcular, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE))
    ...
    private void jButton_CalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_CalcularActionPerformed
        ...
        // Tratamento das excessoes   
        try {
        //Criando contrutor do objeto da classe
        Cilindro redondo = new Cilindro();
        redondo.setRaio(Float.parseFloat(jTextField_Raio.getText().replaceAll(",", ".")));
        redondo.setAltura(Float.parseFloat(jTextField_Altura.getText().replaceAll(",", ".")));
        
        // Saida de dados
        String saida = "Dados do Cilindro: \n";
        saida+= "Area Lateral: "+redondo.calcularAreaLateral()+"\n";
        saida+= "Volume: "+redondo.calcularVolume()+"\n";
        saida+= "Area Total: "+redondo.calcularAreaTotal()+"\n";
