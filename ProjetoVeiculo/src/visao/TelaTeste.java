...
public class TelaTeste extends javax.swing.JFrame {
    ...
    private void jButton_TesteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_TesteActionPerformed
        ...
        //Automovel
        auto = new Automovel("Carro",false);
        String saida = auto.statusDoVeiculo();
        saida+= "\n----------------------------------\n";
        
        //aviao
        aeronave = new Aviao("Boeing 747",true);
        saida += aeronave.statusDoVeiculo();
        saida+= "\n----------------------------------\n";
        
        //Barco
        objBarco = new Barco("Lancha", true);
        saida+= objBarco.statusDoVeiculo();
