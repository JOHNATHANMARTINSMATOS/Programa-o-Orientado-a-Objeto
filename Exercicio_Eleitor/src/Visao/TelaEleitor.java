...
public class TelaEleitor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sistema Eleitor");

        jLabel4.setText("Validação de eleitores");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jTextField_Nome, javax.swing.GroupLayout.PREFERRED_SIZE, 259, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(jTextField_DataNascimento, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGap(33, 33, 33)
                        .addComponent(jButton_Validar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(10, 10, 10)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton_Validar, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton_ValidarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ValidarActionPerformed
        ...
        try {
            pessoa = new Eleitor( jTextField_Nome.getText(),
                                     Integer.parseInt(jTextField_DataNascimento.getText())
                          
            );
            
            //Saida de dados
            
              String saida = "Validação de Eleitor \n";
              saida+= "Nome: "+ pessoa.getNome()+"\n";
              saida+= "Ano de Nascimento: "+ pessoa.getAnoDeNascimento()+"\n";
              saida+= pessoa.calcularTipoDeEleitor();
